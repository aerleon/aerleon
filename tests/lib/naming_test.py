...
class NamingUnitTest(absltest.TestCase):
    ...
    def testGetServiceRecursion(self):
        ...
        self.assertListEqual(self.defs.GetService('SVC2'), [port.PPP("80/tcp"), port.PPP("81/udp"), port.PPP("82/tcp")])

    def testGetService(self):
        """Verify proper results from a service lookup request."""
        self.assertListEqual(self.defs.GetService('SVC1'), [port.PPP("80/tcp"), port.PPP("81/udp"), port.PPP("82/tcp")])
    ...
    def testGetServiceByProto(self):
        self.assertListEqual(self.defs.GetServiceByProto('SVC1', 'tcp'), [port.PPP("80/tcp"), port.PPP("82/tcp")])
    ...
    def testNestedServices(self):
        self.assertListEqual(self.defs.GetServiceByProto('SVC6', 'tcp'), [port.PPP("80/tcp"), port.PPP("82/tcp"), port.PPP("90/tcp")])
