...
BUILTIN_SPEC: "dict[str, TValue | TComposition]" = {
    ...
    'destination-hostname':       TListStrCollapsible,
    ...
    'source-hostname':            TListStrCollapsible,
...
class _Builtin:
    ...
    BUILTINS = {
        ...
        'destination-hostname':       (_CallType.SingleList,   VarType.DESTINATION_HOSTNAME),
        'source-hostname':            (_CallType.SingleList,   VarType.SOURCE_HOSTNAME),
