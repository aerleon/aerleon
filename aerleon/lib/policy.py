...
class Term:
    ...
    members:
      ...
      source/destination_host: list of VarType.(S|D)?HOST's
    ...
    def __str__(self) -> str:
        ...
        if self.source_hostname:
            ret_str.append(f'  source_hostname: {self.source_hostname}')
        if self.source_tag:
        ...
        if self.destination_hostname:
            ret_str.append(f'  destination_hostname: {self.destination_hostname}')
    ...
    def AddObject(self, obj: Union[VarType, List[VarType]]) -> None:
        ...
        if type(obj) is list:
            for x in obj:
                ...
                elif x.var_type is VarType.DESTINATION_HOSTNAME:
                    self.destination_hostname.extend(DEFINITIONS.GetHostnames(x.value))
                elif x.var_type is VarType.SOURCE_HOSTNAME:
                    self.source_hostname.extend(DEFINITIONS.GetHostnames(x.value))
                else:
